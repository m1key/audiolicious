...
@ApplicationScoped
public class AudiobookMapper extends NonAggregateTrackMapper<AudiobookTo> {

	private DataExtractor extractor;

	// For proxying.
	protected AudiobookMapper() {
	}

	@Inject
	public AudiobookMapper(DataExtractor extractor) {
	...
	public AudiobookTo map(Map<XmlNodeName, String> trackValues) {
		...
		String comments = extractor.extractString(trackValues,
