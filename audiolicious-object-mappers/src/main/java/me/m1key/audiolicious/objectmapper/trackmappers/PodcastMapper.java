...
@ApplicationScoped
public class PodcastMapper extends NonAggregateTrackMapper<PodcastTo> {

	private DataExtractor extractor;

	// For proxying.
	protected PodcastMapper() {
	}

	@Inject
	public PodcastMapper(DataExtractor extractor) {
	...
	public boolean canMap(Map<XmlNodeName, String> trackValues) {
		...
		if (genreEquals(trackValues, "Podcast")) {
			return true;
		}
