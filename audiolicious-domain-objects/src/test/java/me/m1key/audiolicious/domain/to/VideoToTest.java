...
public class VideoToTest {
	...
	public void testNotEquals1() {
		...
		VideoTo video1 = new VideoTo("Invisible", "Rainbow in the Dark", "Dio",
				"Dio", 1983, "Rock", dateAdded, dateModified,
				new RatingTo(100), 100, false, 0, 0, false);
		VideoTo video2 = new VideoTo("Invisible", "Rainbow in the Dark2",
	...
	public void testNotEquals2() {
		...
		VideoTo video1 = new VideoTo("Invisible", "Rainbow in the Dark", "Dio",
				"Dio", 1983, "Rock", dateAdded, dateModified,
				new RatingTo(100), 100, false, 0, 0, false);
		VideoTo video2 = new VideoTo("Invisible", "Rainbow in the Dark",
	...
	public void testNotEquals3() {
		...
		VideoTo video1 = new VideoTo("Invisible", "Rainbow in the Dark", "Dio",
				...
				new RatingTo(100), 100, false, 0, 0, false);
		VideoTo video2 = new VideoTo("Invisible", "Rainbow in the Dark", "Dio",
				"Dio2", 1983, "Rock", dateAdded, dateModified,
				new RatingTo(100), 100, false, 0, 0, false);
		assertFalse(video1.equals(video2));
	}
	...
	public void testNotEquals4() {
		...
		VideoTo video1 = new VideoTo("Invisible", "Rainbow in the Dark", "Dio",
				...
				new RatingTo(100), 100, false, 0, 0, false);
		VideoTo video2 = new VideoTo("Invisible", "Rainbow in the Dark", "Dio",
				"Dio", 1983, "Rock2", dateAdded, dateModified,
				new RatingTo(100), 100, false, 0, 0, false);
		assertFalse(video1.equals(video2));
	}
	...
	public void testNotEquals5() {
		...
		VideoTo video1 = new VideoTo("Invisible", "Rainbow in the Dark", "Dio",
				"Dio", 1983, "Rock", dateAdded, dateModified,
				new RatingTo(100), 100, false, 0, 0, false);
		VideoTo video2 = new VideoTo("Invisible2", "Rainbow in the Dark",
				"Dio", "Dio", 1983, "Rock", dateAdded, dateModified,
				new RatingTo(100), 100, false, 0, 0, false);
		assertFalse(video1.equals(video2));
	}
	...
	public void testNotEquals6() {
		...
		VideoTo video1 = new VideoTo("Invisible", "Rainbow in the Dark", "Dio",
				...
				new RatingTo(100), 100, false, 0, 0, false);
		VideoTo video2 = new VideoTo("Invisible", "Rainbow in the Dark", "Dio",
				"Dio", 1983, "Rock", dateAdded, dateModified, new RatingTo(80),
				100, false, 0, 0, false);
		assertFalse(video1.equals(video2));
	}
	...
	public void testNotEquals8() {
		...
		VideoTo video1 = new VideoTo("Invisible", "Rainbow in the Dark", "Dio",
				...
				new RatingTo(100), 100, false, 0, 0, false);
		VideoTo video2 = new VideoTo("Invisible", "Rainbow in the Dark", "Dio",
				"Dio", 1984, "Rock", dateAdded, dateModified,
				new RatingTo(100), 100, false, 0, 0, false);
		assertFalse(video1.equals(video2));
	}
